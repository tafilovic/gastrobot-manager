...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get profileDeleteAccountAction => 'Click to delete';
  ...
  String confirmedResFilterDefaultDateHint(String from, String to) {
    return 'Without custom dates, reservations from $from to $to are shown.';
  }
  ...
  String confirmedResMessageConfirmedWithNote(String note) {
    return 'Your reservation is confirmed. See you soon! Note: $note';
  }
  ...
  String notificationOrderItemEtaBodyNoTime(String productName) {
    return 'Kitchen accepted $productName and is preparing it.';
  }

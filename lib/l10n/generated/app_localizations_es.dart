...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get filterRegionLabel => 'Región';

  @override
  String get filterUniqueCode => 'Código único';

  @override
  String get filterUniqueCodeHint => 'Introducir código...';

  @override
  String get filterAllRegions => 'Todas las regiones';
  ...
  @override
  String get confirmedResMessageLabel => 'Mensaje:';
  ...
  String confirmedResMessageConfirmedWithNote(String note) {
    return 'Tu reserva está confirmada. ¡Nos vemos pronto! Nota: $note';
  }
  ...
  String notificationOrderItemEtaBodyNoTime(String productName) {
    return 'La cocina ha aceptado $productName y lo está preparando.';
  }

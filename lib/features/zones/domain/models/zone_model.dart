...
class ZoneReservation {
  ...
  factory ZoneReservation.fromJson(Map<String, dynamic> json) {
    final rawTime =
...
class ZoneModel {
  ...
  final ZoneReservation? nextReservation;
    ...
    return ZoneModel(
      ...
      nextReservation:
          rawReservation is Map<String, dynamic>
              ? ZoneReservation.fromJson(rawReservation)
              : null,
    );
  }
}

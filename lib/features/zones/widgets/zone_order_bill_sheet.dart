...
/// Bottom sheet showing the bill/cart for [orderForZone] (food/drinks, totals, submit).
void showZoneOrderBillSheet({
  required BuildContext context,
  required ValueListenable<Map<String, int>> cartListenable,
  required ZoneOrderMenuProvider menuProvider,
  ...
  required ZoneModel orderForZone,
  ...
  showModalBottomSheet<void>(
    ...
    builder: (context) => _ZoneOrderBillSheet(
      ...
      onRemove: onRemove,
      onOrder: onOrder,
      orderForZone: orderForZone,
    ),
  );
}

class _ZoneOrderBillSheet extends StatelessWidget {
  const _ZoneOrderBillSheet({
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  zoneQualifiedTitle(l10n, orderForZone),
                  style: const TextStyle(

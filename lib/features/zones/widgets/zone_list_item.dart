...
/// Card in the zones list: zone id row, then (when present) next reservation
/// with date header, chip, time / guest / party rows, and VIDI DETALJE.
class ZoneListItem extends StatelessWidget {
  const ZoneListItem({super.key, required this.zone, this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    final reservation = zone.nextReservation;
    final statusColor =

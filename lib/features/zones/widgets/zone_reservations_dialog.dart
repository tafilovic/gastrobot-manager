...
Future<void> showZoneReservationsDialog(BuildContext context) {
  return showDialog<void>(
    context: context,
    barrierDismissible: true,
    builder: (_) => const _ZoneReservationsDialog(),
  );
}

class _ZoneReservationsDialog extends StatefulWidget {
  const _ZoneReservationsDialog();

  @override
  State<_ZoneReservationsDialog> createState() =>
      _ZoneReservationsDialogState();
}

class _ZoneReservationsDialogState extends State<_ZoneReservationsDialog> {
